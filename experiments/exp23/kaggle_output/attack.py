"""exp23: exp16b race + inj_close_saynothing (gpt-oss turn2 killer from manual probe).

User hand-verified on the interactive probe (hops=8): adding ", then say nothing"
before the harmony close suppresses the final-channel message after the tool call,
cutting the episode from ~1.3s to ~1.0s on gpt-oss. Added as a 7th race template.
