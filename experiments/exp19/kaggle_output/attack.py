"""exp19: minimal-probe replay-aware routing. 2 templates x 1 probe at hops=8, fill at hops=1. Saves ~10 probe trials vs exp17.
...
PROBE_REPS = 1  # exp19: minimal 2-probe routing (latency ratio is 2.4x, 1 sample suffices)
MIN_FIRE_RATE = 0.2
MARGIN_MULT = 1.35
MARGIN_S = 60.0
SLOWEST0 = 24.0
