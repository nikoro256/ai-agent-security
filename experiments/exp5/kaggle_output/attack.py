"""Throughput-optimized single-post search (exp5).

Same K=1 adaptive single-post primitive as the exp2 v5 artifact, with three
throughput changes: REPLAY_SAFE 0.97 (0.99 sits on the invalidation cliff),
a 1-hop fill probe (EXFIL fires at hop 0) with inflated replay accounting,
and a warm-up phase that no longer pollutes the slowest-latency reserve.
