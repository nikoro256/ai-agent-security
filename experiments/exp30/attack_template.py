"""exp30: 12-burst over-listing (12 urls, hops=8 caps at 8 posts but raises exact-8 rate).

(exp29: 8-burst single template (8 urls per message, hops=8 search+fill). From the user probe: 6s/8 fires = 21.7 raw/s vs 18 for single-post.
